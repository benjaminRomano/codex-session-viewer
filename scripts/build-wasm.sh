...
command -v wasm-bindgen >/dev/null || { echo "Install wasm-bindgen-cli 0.2.128 before building." >&2; exit 1; }
[[ "$(wasm-bindgen --version)" == "wasm-bindgen 0.2.128" ]] || { echo "wasm-bindgen-cli 0.2.128 is required to match Cargo.lock." >&2; exit 1; }
